...
import io.github.nicepay.service.v1.impl.DirectV1VirtualAccountServiceImpl
import io.github.nicepay.utils.NICEPay
import org.junit.jupiter.api.Assertions.assertEquals
import org.junit.jupiter.api.Assertions.assertNotNull
import org.junit.jupiter.api.Test

class DirectV1VirtualAccountTest {
    ...
    companion object {
        ...
        private val DEFAULT_REFERENCE_NO = "OrdNo20250902220940"
        private val IS_CLOUD_SERVER = false;
        private var I_MID = "NORMALTEST";
        ...
        val vaService: DirectV1VirtualAccountService = DirectV1VirtualAccountServiceImpl()
    }
    ...
    @Test
    fun `Should be able to register Direct V1 Virtual Account`() {
        ...
        val response: NICEPayResponseV1? = vaService.generateVirtualAccount(virtualAccount, config)
