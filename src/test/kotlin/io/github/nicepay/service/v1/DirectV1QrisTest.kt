...
import io.github.nicepay.service.v1.impl.DirectV1QrisServiceImpl
import io.github.nicepay.utils.NICEPay
import org.junit.jupiter.api.Assertions.assertEquals
import org.junit.jupiter.api.Assertions.assertNotNull
import org.junit.jupiter.api.Test

class DirectV1QrisTest {
    ...
    companion object {
        ...
        val qrisService: DirectV1QrisService = DirectV1QrisServiceImpl()
    }
    ...
    @Test
    fun `Should be able to register Direct V1 Qris`() {

        val config = generateConfig()

        val qrisRequest = DirectV1Qris.Builder()
        ...
        val response: NICEPayResponseV1? = qrisService.registration(qrisRequest, config)
