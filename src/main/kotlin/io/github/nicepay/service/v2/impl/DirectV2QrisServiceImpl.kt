...
class DirectV2QrisServiceImpl : CommonDirectV2ServiceImpl(), DirectV2Service<DirectV2Qris> {

    override fun registration(data: DirectV2Qris, config: NICEPay?): NICEPayResponseV2? {
        var nicePayResponse: NICEPayResponseV2? = null
        val apiHttpService : ApiHttpService<DirectV2Qris, RegistrationDirectV2Api> = ApiHttpServiceImpl()
        try {
