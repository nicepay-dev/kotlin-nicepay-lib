...
class DirectV2VirtualAccountServiceImpl : CommonDirectV2ServiceImpl(), DirectV2Service<DirectV2VirtualAccount> {
    ...
    override fun registration(data: DirectV2VirtualAccount, config: NICEPay?): NICEPayResponseV2? {
        ...
        val apiHttpService : ApiHttpService<DirectV2VirtualAccount, RegistrationDirectV2Api> = ApiHttpServiceImpl()
        try {
