...
class DirectV2PayloanServiceImpl : CommonDirectV2ServiceImpl(), DirectV2Service<DirectV2Payloan> {
    ...
    override fun registration(data: DirectV2Payloan, config: NICEPay?): NICEPayResponseV2? {
        ...
        val apiHttpService : ApiHttpService<DirectV2Payloan, RegistrationDirectV2Api> = ApiHttpServiceImpl()
        try {
