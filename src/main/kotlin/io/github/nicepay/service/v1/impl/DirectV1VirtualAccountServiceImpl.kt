...
import io.github.nicepay.service.v1.DirectV1VirtualAccountService
import io.github.nicepay.utils.ApiCallExecutor
import io.github.nicepay.utils.ApiUtils
import io.github.nicepay.utils.NICEPay
import retrofit2.Call

class DirectV1VirtualAccountServiceImpl : DirectV1VirtualAccountService {

    private val gson = Gson()

    override fun generateVirtualAccount(request: DirectV1VirtualAccount, config: NICEPay): NICEPayResponseV1? {
        ...
        return ApiCallExecutor.executeCall(call, "DIRECT_V1_VIRTUAL_ACCOUNT")
    }
