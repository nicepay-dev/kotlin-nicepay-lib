...
import io.github.nicepay.service.v1.DirectV1QrisService
import io.github.nicepay.utils.ApiCallExecutor
import io.github.nicepay.utils.ApiUtils
import io.github.nicepay.utils.NICEPay
import retrofit2.Call

class DirectV1QrisServiceImpl : DirectV1QrisService {

    private val gson = Gson()

    override fun registration(request: DirectV1Qris, config: NICEPay): NICEPayResponseV1? {
        ...
        return ApiCallExecutor.executeCall(call, "DIRECT_V1_QRIS")
    }
