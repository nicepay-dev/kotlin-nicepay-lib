...
import io.github.nicepay.service.v1.DirectV1DirectDebitService
import io.github.nicepay.utils.ApiCallExecutor
import io.github.nicepay.utils.ApiUtils
import io.github.nicepay.utils.NICEPay
import retrofit2.Call

class DirectV1DirectDebitServiceImpl : DirectV1DirectDebitService {

    private val gson = Gson()

    override fun registration(request: DirectV1DirectDebit, config: NICEPay): NICEPayResponseV1? {
        ...
        return ApiCallExecutor.executeCall(call, "DIRECT_V1_DIRECT_DEBIT")
    }
