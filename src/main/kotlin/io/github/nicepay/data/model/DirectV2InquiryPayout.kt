...
class DirectV2InquiryPayout(
    ...
    class Builder {
        ...
        fun build(): DirectV2InquiryPayout {
            return DirectV2InquiryPayout(
                timeStamp,
                tXid,
                iMid,
                accountNo,
                SHA256Util.encrypt(this.timeStamp + this.iMid + this.tXid + this.accountNo + this.merchantKey).toString()
            )
        }
    }
